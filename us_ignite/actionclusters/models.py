...
class ActionCluster(ApplicationBase):
    ...
    owner = models.ForeignKey(
        'profiles.User', related_name='ownership_set_for_actioncluster',
        blank=True, null=True, on_delete=models.SET_NULL)
    members = models.ManyToManyField(
        'profiles.User', through='actionclusters.ActionClusterMembership',
