# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-01-11 00:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('needs_partner', models.BooleanField(default=False, verbose_name='Looking for a partner?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True, help_text=b'Image suggested ratio: 3:2', max_length=500, upload_to='actionclusters')),
                ...
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='actionclusters.ActionCluster')),
            ],
            options={
                'ordering': ('created',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', django_extensions.db.fields.AutoSlugField(blank=True, editable=False, populate_from='community', unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Domain',
        ...
        migrations.AddField(
            ...
            name='community',
            field=models.ForeignKey(blank=True, help_text='What is the name of the city/community?', null=True, on_delete=django.db.models.deletion.CASCADE, to='actionclusters.Community'),
        ),
        migrations.AddField(
            model_name='actioncluster',
            name='domain',
            field=models.ForeignKey(blank=True, help_text='What is the primary public benefit priority area served by this action cluster?', null=True, on_delete=django.db.models.deletion.CASCADE, to='actionclusters.Domain'),
        ),
        migrations.AddField(
            model_name='actioncluster',
            name='features',
            field=models.ManyToManyField(blank=True, help_text='Check all that apply', to='actionclusters.Feature'),
        ),
        migrations.AddField(
            model_name='actioncluster',
            name='members',
