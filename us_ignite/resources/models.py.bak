...
from us_ignite.common.fields import AutoUUIDField, URL_HELP_TEXT, IMAGE_HELP_TEXT
from us_ignite.resources import managers
# from us_ignite.resources import search
...
class Resource(models.Model):
    """
    Abstract model for ``Resource` fields.
    """
    PUBLISHED = 1
    DRAFT = 2
    REMOVED = 3
